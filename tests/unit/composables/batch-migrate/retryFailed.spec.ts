...
import { ref } from 'vue';
import { createRetry } from '@/composables/batch-migrate/retryFailed';
import { historyDB } from '@/services/database';
import { migrateOneItem } from '@/composables/batch-migrate/migrateCore';
...
vi.mock('@/composables/batch-migrate/historyRefresh', () => ({ notifyMigrationPersisted }));
