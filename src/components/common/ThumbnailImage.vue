...
import { reportThumbnailUrlFailed, reportThumbnailUrlLoaded } from '@/composables/image/useThumbCache';
import { hasUrlListChanged } from '@/composables/image/useThumbnailFallbackChain';
